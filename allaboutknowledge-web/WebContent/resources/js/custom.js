...
function ajaxTest(){
	...
	Seam.createBean('chens.net.allaboutknowledge.web.action.homeAction').getStr('abc', ajaxTestCallback, ajaxTestErrHandler);
}

function ajaxTestCallback(result){
	alert(result);
}

function ajaxTestErrHandler(ex){
	alert(ex.getMessage());
}
